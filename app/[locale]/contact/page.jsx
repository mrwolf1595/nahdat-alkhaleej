...
export default function ContactPage() {
  ...
  const officeLocations = [
    {
      name: 'Main Office',
      address: '123 Real Estate Avenue, Downtown, City 10001',
  ...
  return (
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="rounded-lg overflow-hidden shadow-lg h-64 bg-gray-200">
                  ...
                  <iframe
                    ...
                    frameBorder="0"
                    src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d1150.808047458794!2d39.20115826962789!3d21.60015924568876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjHCsDM2JzAwLjYiTiAzOcKwMTInMDYuNSJF!5e1!3m2!1sen!2ssa!4v1745360234218!5m2!1sen!2ssa"
                    style={{ border: 0 }}
                    allowFullScreen=""
                    aria-hidden="false"
                    tabIndex="0"
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Our main office is conveniently located in the heart of downtown. Feel free to visit us during business hours!
                </p>
              </div>
            </div>
    ...
    </div><Testimonials sectionTitle="Say something about us" /></>
  );
